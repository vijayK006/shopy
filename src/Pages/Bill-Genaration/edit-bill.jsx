...
//                     totalamount: firmData.totalamount,
...
//         if (confirmUpdate) {
//             axios.post(`https://digitalshopee.online/api/lead-generation/edit-lead.php?id=${id}`, valueData, {
//                 headers: {
...
//                                 <input type='text' className='form-control' value={valueData.client_id} name='client_id' placeholder='' onChange={handleChange} />
//                             </div>
//                             <div className='col-md-3 py-1'>
...
//                                         <input type='text' className='form-control' value={item.service_code} name={`item-${index}-service_code`} placeholder='' onChange={handleChange} />
//                                     </div>
//                                     <div className='col-md-2 py-1'>
//                                         <label className='text-sm font-w-500 p-2'>Service Name</label>

//                     <select className='form-control' value={item.service_name} name={`item-${index}-service_name`} onChange={handleChange}>
...
//                                 </div>
//                             ))}
//                             <div className='col-md-12 py-1 d-flex justify-content-end'>
