...
//     setFormData({ ...formData, items }, calculateTotalAmount);
...
//     setFormData(prevFormData => ({ ...prevFormData, total: totalAmount }));
//   };
...
const Add_bill = () => {
  ...
  // useEffect to recalculate total whenever items change
  useEffect(() => {
    calculateTotalAmount();
  }, [formData.items]);
