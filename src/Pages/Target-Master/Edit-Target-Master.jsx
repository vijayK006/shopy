...
//     useEffect(() => {
//         axios.get(`https://shopee-firm.000webhostapp.com/api/target/get-by-id-target.php?id=${id}`)
//             .then(response => {
...
//                     <p className='margin-0 font-w-500'><Link to='/'>Dashboard</Link> / <Link to='/target-master'>Target Master</Link> / <Link className='t-theme-color'>Edit Target Master Details</Link></p>
...
//                             <div className='col-md-4 py-1'>
//                                 <label className='text-sm font-w-500 p-2'>Total Target Amount</label>
//                                 <input type='number' className='form-control' value={valueData.total_amount} name='total_amount' placeholder='Please enter service amount' onChange={handleChange} />
...
//                                 <input type='text' className='form-control' value={valueData.date} name='date' placeholder='' onChange={handleChange} />
